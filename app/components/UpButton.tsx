...
export default function UpButton({clicked , onClick}:{clicked: boolean, onClick?: () => void}) {
    const [hover, setHover] = useState(clicked ? 'var(--green)' : 'white')
  return (
    <button className='hover:bg-[var(--light-green)] p-2 rounded-xl text-white w-auto'
